...
const mainHtml = (
  <>
    <div class="legal-hero wrap">
      ...
      <h1>
        Privacidad, <em>términos</em> y condiciones.
      </h1>
      <p class="legal-meta">
        ...
        <aside class="legal-sidebar">
          <nav aria-label="Índice de secciones">
            ...
            <a href="#pp-descripcion">
              <span class="snum">§1</span> Descripción
            </a>
            <a href="#pp-datos">
              <span class="snum">§2</span> Datos recopilados
            </a>
            <a href="#pp-permisos">
              <span class="snum">§3</span> Permisos y alcance
            </a>
            <a href="#pp-oauth">
              <span class="snum">§4</span> Google OAuth
            </a>
            <a href="#pp-limited-use">
              <span class="snum">§5</span> Limited Use
            </a>
            <a href="#pp-terceros">
              <span class="snum">§6</span> Servicios de terceros
            </a>
            <a href="#pp-menores">
              <span class="snum">§7</span> Menores de edad
            </a>
            <a href="#pp-cambios">
              <span class="snum">§8</span> Cambios
            </a>

            <div class="sidebar-section">Términos</div>
            <a href="#tos-uso">
              <span class="snum">§9</span> Uso permitido
            </a>
            <a href="#tos-licencia">
              <span class="snum">§10</span> Licencia
            </a>
            <a href="#tos-disponibilidad">
              <span class="snum">§11</span> Disponibilidad
            </a>

            <div class="sidebar-section">Responsabilidades</div>
            <a href="#disc-exactitud">
              <span class="snum">§12</span> Exactitud de sugerencias
            </a>
            <a href="#disc-limitacion">
              <span class="snum">§13</span> Limitación de responsabilidad
            </a>
            <a href="#disc-google">
              <span class="snum">§14</span> Relación con Google
            </a>

            <div class="sidebar-section">Contacto</div>
            <a href="#contacto">
              <span class="snum">§15</span> Contacto
            </a>
          </nav>
        </aside>
        ...
        <div class="legal-article">
          ...
          <details class="legal-toc-mobile">
            ...
            <ol>
              ...
              <li>
                <a href="#pp-datos">Datos recopilados</a>
              </li>
              <li>
                <a href="#pp-permisos">Permisos y alcance</a>
              </li>
              <li>
              ...
              <li>
                <a href="#pp-terceros">Servicios de terceros</a>
              </li>
              <li>
                <a href="#pp-menores">Menores de edad</a>
              </li>
              <li>
                <a href="#pp-cambios">Cambios a esta política</a>
              </li>
              <li>
                <a href="#tos-uso">Uso permitido</a>
              </li>
              <li>
                <a href="#tos-licencia">Licencia</a>
              </li>
              <li>
                <a href="#tos-disponibilidad">Disponibilidad</a>
              </li>
              <li>
                <a href="#disc-exactitud">Exactitud de sugerencias</a>
              </li>
              <li>
                <a href="#disc-limitacion">Limitación de responsabilidad</a>
              </li>
              <li>
                <a href="#disc-google">Relación con Google</a>
              </li>
              <li>
          ...
          <section id="privacidad">
            ...
            <h2>
              Cómo tratamos <em>tus datos</em>.
            </h2>
            <p>
              Esta política describe qué información recopila, accede o utiliza
              la extensión <strong>Lenguaje Claro</strong> y cómo se usan los
              permisos que solicita. Aplica a la versión actual de la extensión
              y a las futuras versiones que se distribuyan a través de la Chrome
              Web Store.
            </p>
          </section>
          ...
          <section id="pp-descripcion">
            ...
            <p>
              ...
              de lenguaje claro aplicados al ámbito jurídico. Detecta arcaísmos,
              tecnicismos, nominalizaciones, voz pasiva, rodeos innecesarios,
              queísmo/dequeísmo y números escritos con palabras.
            </p>
            <p>
              ...
              con la extensión. La extensión no se conecta a servidores propios
              ni a servicios de terceros ajenos a Google. Para funcionar, se
              comunica únicamente con Google OAuth y con la API de Google Docs
              para leer el documento activo y, cuando el usuario lo confirma,
              enviar la instrucción necesaria para aplicar un reemplazo en ese
              mismo documento. No utiliza servicios de inteligencia artificial
              en la nube ni telemetría propia.
            </p>
          </section>
          ...
          <section id="pp-datos">
            ...
            <div class="callout">
              ...
              datos personales ni contenido de documentos en servidores propios.
              El sitio web sí puede tratar la dirección de email que una persona
              deja voluntariamente en la lista de espera de la versión Pro.
            </div>

            <p>Distinguimos entre dos contextos distintos:</p>
            <ul>
              <li>
                <strong>Extensión de Chrome</strong> — la extensión no recopila
                nombre, apellido, dirección de email, identificadores de cuenta
                ni contenido de documentos en infraestructura propia. Se opera
                únicamente en Google Docs. El análisis corre localmente en el
                navegador.
              </li>
              <li>
              ...
              <li>
                ...
                están activas, cuántas sugerencias se aceptan o rechazan, tiempo
                de sesión ni ningún otro evento de uso.
              </li>
              <li>
                <strong>Datos de autenticación</strong> — los tokens de acceso
                OAuth son gestionados por Chrome. La extensión no los persiste
                en almacenamiento propio ni los comparte con terceros; solo los
                usa en memoria durante la sesión para autenticar las solicitudes
                a la API de Google Docs.
              </li>
              <li>
                <strong>Preferencias del usuario</strong> — los estados de
                activación de la extensión se guardan localmente en{" "}
                <code>chrome.storage</code>. En particular, se conserva si la
                extensión está habilitada globalmente (
                <code>extensionEnabled</code>) y los IDs de documentos donde el
                usuario la desactiva (<code>disabledDocs</code>). Esa
                información permanece en el navegador del usuario, no se
                transmite a servidores propios ni a terceros, y no contiene
                contenido de documentos.
              </li>
              <li>
                <strong>Datos de ubicación o dispositivo</strong> — no accedemos
                a la geolocalización, identificadores de hardware ni información
                del sistema operativo.
              </li>
              <li>
                <strong>Lista de espera del sitio web</strong> — si una persona
                deja voluntariamente su email para ser avisada sobre Lenguaje
                Claro Pro, esa dirección se almacena en una base de datos.
              </li>
              <li>
                <strong>Correo transaccional</strong> — al registrarse en la
                waitlist, el sitio puede enviar un mail de confirmación. Ese
                email se usa para confirmar la suscripción y, más adelante, para
                avisar el lanzamiento de la versión Pro.
              </li>
            </ul>
          </section>
          ...
          <section id="pp-permisos">
            ...
            <p>
              ...
              Además, sus scripts solo se cargan dentro de{" "}
              <code>docs.google.com</code> y la funcionalidad de revisión se
              inicializa sobre documentos válidos de Google Docs. Cada permiso o
              alcance tiene un propósito único y necesario para el
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    necesario para obtener acceso a la API de Google Docs y leer
                    el texto del documento activo.
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    ...
                    extensión (<code>extensionEnabled</code>) y la lista de IDs
                    de documentos donde el usuario la desactiva (
                    <code>disabledDocs</code>). Los datos se almacenan
                    exclusivamente en el navegador del usuario mediante{" "}
                    <code>chrome.storage</code> y no se transmiten fuera del
                    equipo.
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    Permitir que, cuando el usuario abre el popup, la extensión
                    acceda temporalmente a la pestaña activa y a su URL para
                    detectar si la página actual es un Google Doc y mostrar el
                    toggle por documento. Esto evita solicitar el permiso más
                    amplio <code>tabs</code> o acceso permanente a todas las
                    pestañas del navegador.
                  </td>
                </tr>
                <tr>
                  <td>
                    <code>host_permissions: https://docs.googleapis.com/*</code>
                  </td>
                  <td>
                    Realizar llamadas a la API de Google Docs (v1) para leer el
                    documento activo y aplicar cambios aceptados por el usuario.
                    Sin este permiso no es posible acceder al contenido mediante
                    la API oficial.
                  </td>
                </tr>
                <tr>
                  <td>
                    <code>
                      content_scripts.matches: https://docs.google.com/*
                    </code>
                  </td>
                  <td>
                    Los scripts de la extensión solo se cargan en{" "}
                    <code>docs.google.com</code>. La revisión del texto y la
          ...
          <section id="pp-oauth">
            ...
            <p>
              Este scope permite leer y modificar documentos de Google Docs.{" "}
              <strong>
                La extensión únicamente lee el texto del documento activo
              </strong>
            ...
            <p>
              La extensión <strong>nunca</strong>:
            </p>
            <ul>
              <li>
                Accede a documentos distintos del que está abierto en la pestaña
                activa.
              </li>
              <li>Lee el listado de documentos del usuario en Google Drive.</li>
              <li>
                Realiza modificaciones automáticas sin confirmación explícita
                del usuario.
              </li>
              <li>
                Almacena el contenido del documento en servidores propios ni lo
                comparte con terceros ajenos a Google.
              </li>
              <li>Comparte el token de acceso con terceros.</li>
            </ul>
            <p>
              El token de acceso OAuth es gestionado por el propio Chrome a
              través del permiso <code>identity</code>. La extensión lo utiliza
              únicamente para autenticar las solicitudes a la API de Google Docs
          ...
          <section id="pp-limited-use">
            ...
            <p>
              ...
              entrenamiento de modelos, venta de datos ni para fines ajenos a la
              funcionalidad principal de la extensión. No compartimos el
            ...
            <p>
              El uso de la información recibida desde Google APIs adherirá a la
              Chrome Web Store User Data Policy, incluidos los requisitos de
              Limited Use.
            </p>
          </section>
          ...
          <section id="pp-terceros">
            ...
            <p>
              ...
              externo: sin modelos de inteligencia artificial, sin servicios de
              crash reporting y sin telemetría propia.
            </p>
            <p>
              El <strong>sitio web</strong> de la extensión (
              <code>extensionlenguajeclaro.com.ar</code>) utiliza Google
              Analytics para medir visitas a la página de presentación. Además,
              el formulario de la lista de espera almacena email en una base de
              datos. Estas tomas de datos son independiente del funcionamiento
              de la extensión y no afectan ni estan relacionadas al
              procesamiento de documentos dentro de la misma.
            </p>
          </section>
          ...
          <section id="pp-cambios">
            ...
            <p>
              ...
              análisis semántico en la nube— ello se documentará con claridad en
              esta página.
            </p>
            <p>
              ...
              Store y, de ser posible, mediante un aviso dentro de la extensión.
            </p>
            <p style="color: var(--ink-3); font-size: 13px">
              Versión actual de esta política: 1.1 · Fecha: 20 de abril de 2026.
            </p>
          </section>
          ...
          <section id="terminos">
            ...
            <h2>
              Condiciones de <em>uso</em>.
            </h2>
            <p>
              Al instalar y utilizar la extensión{" "}
              <strong>Lenguaje Claro</strong>, el usuario acepta los siguientes
              términos. Si no está de acuerdo con alguno de ellos, debe
          ...
          <section id="tos-uso">
            ...
            <p>
              ...
              jurídicos en Google Docs, siguiendo principios de lenguaje claro.
              Su uso implica aceptar que:
            </p>
            <ul>
              <li>
                Las sugerencias son orientativas y no constituyen asesoramiento
                legal ni lingüístico profesional.
              </li>
              <li>
              ...
              <li>
                Queda prohibido el uso de la extensión para recopilar, extraer o
                procesar masivamente contenido de documentos de terceros sin su
                consentimiento.
              </li>
            </ul>
          </section>
          ...
          <section id="tos-licencia">
            ...
            <p>
              El código fuente de la extensión está publicado bajo la{" "}
              <strong>licencia MIT</strong>. Esto significa que cualquier
              persona puede usar, copiar, modificar, fusionar, publicar,
              distribuir, sublicenciar y/o vender copias del software, sujeto a
            ...
            <p>
              ...
              se distribuye "tal cual", sin garantía de funcionamiento correcto,
              continuidad del servicio ni adecuación a un propósito específico.
            </p>
          </section>
          ...
          <section id="tos-disponibilidad">
            ...
            <p>
              La extensión se encuentra actualmente en{" "}
              <strong>beta pública</strong>. Puede contener errores,
          ...
          <section id="responsabilidades">
            <span class="section-label">
              03 — Exención de responsabilidades
            </span>
            <h2>
              Limitaciones y <em>advertencias</em>.
            </h2>
          </section>
          ...
          <section id="disc-exactitud">
            ...
            <p>
              ...
              texto predefinidos aplicados localmente. El análisis es sintáctico
              superficial y <strong>no comprende el contexto semántico</strong>{" "}
              de los documentos. Por esta razón:
            </p>
            <ul>
              <li>
              ...
              <li>
                Las sugerencias de voz pasiva y de vaguedades requieren revisión
                manual, ya que la herramienta no puede reconstruir el texto
                exacto sin conocer el sujeto real de la oración o el dato
                concreto.
              </li>
              <li>
          ...
          <section id="disc-limitacion">
            ...
            <p>
              ...
              desarrollador de la extensión <strong>Lenguaje Claro</strong>{" "}
              (Guillermo Perez) no será responsable por:
            </p>
            <ul>
              <li>
              ...
              <li>
                Incompatibilidades con versiones futuras del navegador Chrome o
                de Google Docs.
              </li>
            </ul>
            <p>
          ...
          <section id="disc-google">
            ...
            <p>
              ...
              desarrollado por Guillermo Perez. No está afiliado, patrocinado ni
              respaldado por Google LLC. "Google Docs", "Google Chrome" y
          ...
          <section id="contacto">
            ...
            <p>
              Para dudas sobre esta política de privacidad, reportes de errores,
              solicitudes relacionadas con tus datos o cualquier consulta sobre
              el funcionamiento de la extensión, podés comunicarte a través de
              LinkedIn. Si buscás una referencia rápida para soporte, también
              podés visitar la <a href="support.html">página de soporte</a>.
            </p>
            <ul>
              <li>
            ...
            <p>
              Haré lo posible por responder en un plazo razonable, teniendo en
              cuenta que este es un proyecto desarrollado y mantenido en mi
              tiempo libre.
            </p>
          </section>
        </div>
...
export default function LegalPage() {
  return (
    <Document
      ...
      extraHead={<link rel="stylesheet" href="legal.css" />}
    >
      <Header />
      <main>{mainHtml}</main>
      <Footer />
