...
const mainHtml = String.raw`<!-- =======================  HERO  ======================= -->
      <section class="hero wrap">
        <div class="hero-grid">
          <div>
            <span class="eyebrow"
              ><span class="dot"></span> Beta pública · código abierto</span
            >

            <h1 class="hero-title">
              Escritura <em>jurídica</em> que <span class="under">se entiende</span>.
            </h1>

            <p class="hero-lede">
              Una extensión de Chrome que revisa tus textos en Google Docs y
              sugiere mejoras siguiendo los principios del <b>lenguaje claro</b> en el ámbito del derecho.
            </p>
      ...
      <section class="block wrap">
        <div class="block-header">
          <div class="kicker"><span class="num">01</span> Por qué existe</div>
          <div>
            <h2 class="section-title">
              El derecho se lee <em>poco</em><br />porque se escribe <em>mal</em>.
            </h2>
            <p class="section-sub">
              La <a
                ...
                "
                >Red Argentina de Lenguaje Claro</a
              >
        ...
        <div class="why-grid">
          ...
          <div class="why-cell">
            ...
            <div class="why-body">
              ...
              de Google necesarios para leer el documento activo y aplicar
              cambios confirmados por el usuario.
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="block wrap" id="features">
        ...
        <div class="feat-grid">
          <div class="feat">
            ...
            <div class="feat-ex">
              <div class="pair">
                <span class="from">in fine</span><span class="arrow">→</span
              ...
              <div class="pair">
                <span class="from">otrosí digo</span><span class="arrow">→</span
          ...
          <div class="feat">
            ...
            <div class="feat-desc">
              ...
              personas que no son del derecho.
            </div>
            <div class="feat-ex">
              <div class="pair">
                <span class="from">prestatario</span><span class="arrow">→</span
                ><span class="to">persona que recibe un préstamo</span>
              </div>
              <div class="pair">
                <span class="from">mora</span><span class="arrow">→</span
                ><span class="to">retraso</span>
              </div>
              <div class="pair">
                <span class="from">enajenar</span><span class="arrow">→</span
          ...
          <div class="feat">
            ...
            <div class="feat-ex">
              <div class="pair">
                <span class="from">mucho</span><span class="arrow">→</span
          ...
          <div class="feat">
            ...
            <div class="feat-desc">
              Identifica perífrasis comunes y propone la forma corta
              equivalente.
            </div>
            <div class="feat-ex">
              <div class="pair">
                <span class="from">en el momento actual</span
                ><span class="arrow">→</span><span class="to">ahora</span>
              </div>
              <div class="pair">
                <span class="from">a fin de</span><span class="arrow">→</span
                ><span class="to">para</span>
              </div>
              <div class="pair">
                <span class="from">de conformidad con</span
                ><span class="arrow">→</span><span class="to">según</span>
              </div>
            </div>
          </div>
          ...
          <div class="feat">
            ...
            <div class="feat-ex">
              ...
              <div class="pair">
                ...
                ><span class="arrow">→</span><span class="to">pienso que</span>
              </div>
            </div>
            <div class="feat-note">
          ...
          <div class="feat">
            ...
            <div class="feat-ex">
              <div class="pair">
                ...
                ><span class="arrow">→</span><span class="to">considerar</span>
              </div>
              <div class="pair">
                <span class="from">dar comienzo</span
                ><span class="arrow">→</span><span class="to">comenzar</span>
              </div>
              <div class="pair">
          ...
          <div class="feat">
            ...
            <div class="feat-ex">
              <div class="pair">
                ...
                ><span class="arrow">→</span><span class="to">32</span>
              </div>
              <div class="pair">
                <span class="from">Artículo XIV</span
                ><span class="arrow">→</span><span class="to">Artículo 14</span>
              </div>
            </div>
            <div class="feat-note">
        ...
        <div class="note-box">
          ...
          más que la API de Google Docs. Es un proyecto simple,
          que no usa servidores propios ni tampoco IAs, lo cual implica que el
          sistema no comprende la estructura gramatical a fondo ni el
          significado de las oraciones. Como resultado, algunas sugerencias
          requieren revisión manual, ciertos casos ambiguos pueden generar
          falsos positivos, y reglas como voz pasiva o vaguedades no pueden
          reconstruir ni proponer el texto exacto sin conocer el contexto
          semántico del documento.
        </div>
      </section>
      ...
      <section class="block wrap">
        <div class="block-header">
          <div class="kicker"><span class="num">03</span> En acción</div>
          <div>
            <h2 class="section-title">Así se ve en tu <em>Google Docs</em>.</h2>
            <p class="section-sub">
              El panel lateral agrupa las sugerencias por categoría y las
              muestra numeradas. Podés aplicar un cambio con un clic o expandir
        ...
        <div class="shot-caption">
          <span
            >Captura sobre un contrato de prestación de servicios
            profesionales</span
          >
      ...
      <section class="block wrap" id="comparacion">
        <div class="block-header">
          <div class="kicker"><span class="num">04</span> Comparación</div>
          <div>
            <h2 class="section-title">
              Complementa otras herramientas — <em>no las reemplaza</em>.
            </h2>
            <p class="section-sub">
              Existen correctores de estilo excelentes en el mercado, pero
              ninguno está enfocado en lenguaje claro aplicado al derecho en
              español. <b>Lenguaje Claro</b> cubre ese hueco y se puede usar
              junto a una herramienta general como LanguageTool sin
              superposición: nuestra extensión no hace análisis contextual ni
              semántico.
            </p>
          </div>
        </div>
          ...
          <table class="comp-table">
            ...
            <tbody>
              <tr class="mine">
                ...
                <td class="centered"><span class="check yes">✓</span></td>
                <td class="centered"><span class="check yes">✓</span></td>
                <td class="centered"><span class="check yes">✓</span></td>
              </tr>
              <tr>
                <td>
                  <div class="tool">Grammarly<small>grammarly.com</small></div>
                </td>
                <td>Gramática y estilo general</td>
                <td class="centered"><span class="check no">×</span></td>
                <td class="centered"><span class="check no">×</span></td>
                <td class="centered">
              ...
              <tr>
                <td>
                  <div class="tool">Wordtune<small>wordtune.com</small></div>
                </td>
      ...
      <section class="block wrap" id="privacidad">
        <div class="block-header">
          <div class="kicker"><span class="num">05</span> Privacidad</div>
          <div>
            <h2 class="section-title">
        ...
        <div class="priv-grid">
          <div class="priv-cell">
            ...
            <div class="d">
              No guardamos texto, telemetría ni identificadores en
              infraestructura propia. Solo se conserva en tu navegador el estado de
              activación de la extensión, es decir, si está prendida o apagada.
            </div>
          </div>
          <div class="priv-cell">
            ...
            <div class="d">
              La extensión solo se activa y propone cambios en <code style="font-family: var(--font-mono); font-size: 0.9em"
                >http://docs.google.com</code
              >.
            </div>
          </div>
          <div class="priv-cell">
        ...
        <div class="cta-block">
          ...
          <div>
            ...
            <p class="cta-consent">
              ...
              avisarte cuando salga la versión Pro. Más info en la <a href="legal.html#pp-datos">política de privacidad</a>.
            </p>
            <div
              class="cta-feedback"
              id="cta-feedback"
...
const waitlistScript = String.raw`const waitlistForm = document.getElementById("waitlist");
      const waitlistEmail = document.getElementById("waitlist-email");
      const waitlistFeedback = document.getElementById("cta-feedback");
      const waitlistSubmit = waitlistForm?.querySelector(
        'button[type="submit"]',
      );
  ...
  return (
    <Document
      ...
      afterBody={
        <>
          <SharedScripts />
          <InlineScript code={waitlistScript} />
